...
public class DSORadioGroup extends RelativeLayout {
    ...
    public void addView(View child, int index, ViewGroup.LayoutParams params) {
        if (child instanceof CheckableLinearLayout) {
            final CheckableLinearLayout button = (CheckableLinearLayout) child;
            if (button.isChecked()) {
                mProtectFromCheckedChange = true;
                if (mCheckedId != -1) {
    ...
    private void setCheckedStateForView(int viewId, boolean checked) {
        ...
        if (checkedView != null && checkedView instanceof CheckableLinearLayout) {
            ((CheckableLinearLayout) checkedView).setChecked(checked);
        }
    }
    ...
    public LayoutParams generateLayoutParams(AttributeSet attrs) {
        return new DSORadioGroup.LayoutParams(getContext(), attrs);
    }
    ...
    public CharSequence getAccessibilityClassName() {
        return CheckableLinearLayout.class.getName();
    }
    ...
    private class CheckedStateTracker implements CheckableLinearLayout.OnCheckedChangeListener {
        @Override
        public void onCheckedChanged(CheckableLinearLayout buttonView, boolean isChecked) {
    ...
    private class PassThroughHierarchyChangeListener implements
        ...
        public void onChildViewAdded(View parent, View child) {
            if (parent == DSORadioGroup.this && child instanceof CheckableLinearLayout) {
                int id = child.getId();
        ...
        public void onChildViewRemoved(View parent, View child) {
            if (parent == DSORadioGroup.this && child instanceof CheckableLinearLayout) {
                ((CheckableLinearLayout) child).setOnCheckedChangeListener(null);
            }
